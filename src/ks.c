...
/*
  ...
  extern SEXP pKS2(SEXP sn, SEXP stol);

  static double psmirnov2x(double *x, int m, int n);

  extern void pkstwo(int n, double *x, double tol);
*/


void
R_init_psistat(DllInfo *info)
{
  ...
  R_forceSymbols(info, TRUE); /* R_forceSymbols needs R (>= 3.0.0) */
}
